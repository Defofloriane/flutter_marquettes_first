...
import 'package:market_flutter/pages/buinesSlipUpPage.dart';
import 'package:market_flutter/themes/colors.dart';


class BuinnessPage extends StatefulWidget {
  const BuinnessPage({Key? key}) : super(key: key);

  @override
  State<BuinnessPage> createState() => _BuinnessPageState();
}

class _BuinnessPageState extends State<BuinnessPage> {
  @override
